...
class StaggerAnimation extends StatelessWidget {
  StaggerAnimation({
    ...
    color = ColorTween(
      begin: Color.fromARGB(255, 0, 17, 1),
      end: Color.fromARGB(255, 67, 3, 3),
    ).animate(
      CurvedAnimation(
        parent: controller,
        curve: const Interval(
...
class _StaggerRouteState extends State<StaggerRoute>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('通过增加柱子的高度进行动画'),
      ),
      body: Center(
        child: Column(
          children: [
